...
var result = mergeArray1(arr1,arr2); //[4, 5, 8, 8, 9, 10]
~~~
...
var arr1 = [4,8,10], arr2 = [5,8,9];
var result = mergeArray2(arr1,arr2); //[4, 5, 8, 8, 9, 10]
~~~
...
function mergeArray4(arr1, arr2) {
  ...
  while (current < (arr1.length + arr2.length)) {
    ...
    if (unmerged1 < unmerged2) { // if next comes from arr1
      merged[current] = unmerged1;
      index1++;
    } else { // if next comes from arr2
...
var arr1 = [4,8,10], arr2 = [5,8,9,12];
var result = mergeArray4(arr1,arr2); //[4, 5, 8, 8, 9, 10,12]
